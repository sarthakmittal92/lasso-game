...
//class Sprite inheriting public members of class MovingObject

{
  
  vector<Sprite*> parts;
  //vector stores pointers to all parts
 ...
 MovingObject(double speed, double angle_deg, double argax, double argay, bool argpaused, bool rtheta) : Sprite() {
  ...
  //member functions for pausing/resuming/checking
